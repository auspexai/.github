...
A volunteer-driven, open-source distributed compute network for AI safety research. Researchers submit experiments; volunteers worldwide donate compute by running a sandboxed worker. Tenant-neutral by design; the first project to run on the network is [Sentinel](https://github.com/jasongagne-git/sentinel) — multi-agent LLM behavioral drift research.
