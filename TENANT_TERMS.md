...
1. The coordinator assembles a self-contained, offline-verifiable bundle: your consensus result payloads, their COSE-signed receipts, and your signed experiment manifest.
...
**Keep your downloaded bundle.** After collection we do not guarantee that the coordinator still holds your result payloads — by design, it may discard them once you hold the authoritative copy.
